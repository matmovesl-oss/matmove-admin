...
import { FileCheck, Wallet, Banknote, Users, ScrollText, ShieldCheck, X, Radar, Activity, BriefcaseBusiness, Tag } from 'lucide-react';
...
const nav = [
  ...
  { to: '/pricing', label: 'Vehicle Pricing', icon: Tag }, // NEW TAB
