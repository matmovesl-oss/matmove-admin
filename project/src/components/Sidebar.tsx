...
export default function Sidebar({ open, onClose }: SidebarProps) {
  return (
    <>
      ...
      <aside
        className={`fixed z-40 inset-y-0 left-0 w-72 bg-slate-900 text-slate-200 flex flex-col transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="px-6 py-4 border-t border-slate-800">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-700 flex items-center justify-center text-white text-sm font-semibold">
              HB
            </div>
            <div className="min-w-0">
              <p className="text-sm font-medium text-white truncate">Hawa Bangura</p>
